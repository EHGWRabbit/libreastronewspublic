...
urlpatterns = [
   ...
   #path('accounts/password/reset/done/', ResetPasswordDoneView.as_view(), name='eset_done'),
   #path('accounts/password/reset/complete', ResetPasswordCompleteView.as_view(), name='reset_complete'),
